...
const Paths = {
  ...
  JS: {
    ...
    THEME: [
      ...
      'js/theme/**/!(Utils | bootstrap-navbar | bootstrap-select-menu | detector | forms | stickyfill | stickykit | tooltip)*.js',
    ],
    PLUGINS: [
      'js/plugins/imagesloaded.pkgd.js', // Required for preloader
      'js/plugins/TweenMax.js', // Required for zanimtion
      'js/plugins/ScrollToPlugin.js', // Required for smooth animation on scroll (fancyscroll)
      'js/plugins/CustomEase.js', // Required for zanimation
      'js/plugins/DrawSVGPlugin.js', // Required for zanimation
      'js/plugins/all.min.js'
    ],
  },
  SCSS: {
    ALL: 'scss/**/*.scss',
